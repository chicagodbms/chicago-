...
<?php
  if ($_SESSION['ADMIN_EMAIL'] == ""){
    ...
    echo "<p>Please fill in new shoes information below. </p><br>";
  	...
  	echo '<form name = "main_form" action="finish_add_case.php" onsubmit="return validateForm()" method="post">
    ...
    echo '<p><a href = "manage_case%20.php">Back</a> to product management</p>';
  }
?>
